...
import { PatternRotation, StyledBlockName, StyledButton, StyledDimensions, StyledDivDimens, StyledImg, StyledInput, StyledLi, StyledP, StyledSelect, StyledTextArea } from '../OptionSection.styled'
import EdgePreview from '../EdgePreview/EdgePreview'

const DetailDemansions = ({product, language, handleChangeInput ,handleOpenEdgeBlock,handleCloseEdgeBlock, edgeBlock , handleEdgeSide, handleImageClick, handleChangeComment, handleChangeSelect}) => {
